    ...
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: 'Jura, sans-serif' }}>
      <div className={styles.hero}>
        ...
        <div className={styles.mainContent}>       
            ...
            <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to ChopLab, 2201 S Knox Ct.</p>
            </li>
            <li>
            ...
            <li>
            <p><strong>Website</strong> refers to ChopLab, accessible from <a href="https://thechoplab.com" rel="external nofollow noopener" target="_blank">https://thechoplab.com</a></p>
            </li>
            <li>
            ...
            <ul>
            <li>
            <p>By email: thechoplab@gmail.com</p>
            </li>
            <li>
            <p>By visiting this page on our website: <a href="https://thechoplab.com/contact/" rel="external nofollow noopener" target="_blank">https://thechoplab.com/contact/</a></p>
            </li>
            </ul>
        </div>
        </div>
